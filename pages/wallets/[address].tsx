...
const Wallet = () => {
  ...
  return (
    <Layout>
      <>
        <Head>
          {!wallet.address && <title>Loading wallet...</title>}
          {wallet.address && claimed && (
            <title>
              MetaWallet -{' '}
              {wallet.walletData[2] ? wallet.walletData[2] : wallet.address}
            </title>
          )}
          {wallet.address && !claimed && (
            <title>MetaWallet - {wallet.address}</title>
          )}
        </Head>
        <div
